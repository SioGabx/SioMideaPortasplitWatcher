...
{
    public class TechnomatStockChecker : IStockChecker
    {
        public class TechnomatStore
        {
        ...
        {
            public TechnomatStore Store { get; }
            public int Quantity { get; }

            public StockEventArgs(TechnomatStore store, int quantity)
            {
                Store = store;
                Quantity = quantity;
            }
